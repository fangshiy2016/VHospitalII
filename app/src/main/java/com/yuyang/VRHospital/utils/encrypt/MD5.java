...
public class MD5 {
	...
	public static void main(String[] args) {
		...
		String hehe = toMD5("很晚sod佛诶哦iasdjf");
		System.out.println(hehe);
		hehe = toMD5("很晚sod佛诶哦iasdjf");
		System.out.println(hehe);
	}
	...
	public String getMD5ofStr16(String s) {// 返回MD5串；
		int i;
		md5Init();
		md5Update(s.getBytes(), 16);
		md5Final();
		digestHexStr = "";
		for (i = 0; i < 16; i++)
			digestHexStr = digestHexStr + byteHEX(digest[i]);
	...
	public static String toMD516(String s) {
		MD5 md5 = new MD5();
		return md5.getMD5ofStr16(s);
	}
}
