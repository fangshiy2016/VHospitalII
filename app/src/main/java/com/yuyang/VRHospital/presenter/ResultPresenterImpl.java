 ...
 */
public class ResultPresenterImpl extends CallbackListener<ResultBean> implements IResultPresenter {
    private IDiagnoseResultActivity resultActivity;
    private IResultModel resultModel;

    public ResultPresenterImpl(IDiagnoseResultActivity activity){
